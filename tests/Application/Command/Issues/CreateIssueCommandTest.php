 ...
 * @covers \eTraxis\Application\Command\Issues\Handler\CreateIssueHandler::__invoke
 */
class CreateIssueCommandTest extends TransactionalTestCase
{
    ...
    public function testSuccessNoResponsible()
    {
        ...
        static::assertSame($template->initialState, $issue->state);
        ...
        $values = array_filter($issue->values, fn (FieldValue $value) => $value->field->state === $template->initialState);
    ...
    public function testFailedWithResponsible()
    {
        ...
        $this->expectExceptionMessage('Message of type "eTraxis\Application\Command\Issues\CreateIssueCommand" failed validation.');
