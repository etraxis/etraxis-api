...
class TextTraitTest extends TransactionalTestCase
{
    ...
    public function testValidationConstraints()
    {
        ...
        static::assertSame('This value is too long. It should have 2000 characters or less.', $errors->get(0)->getMessage());
    ...
    public function testMaximumLength()
    {
        ...
        static::assertSame(TextInterface::MIN_LENGTH, $this->facade->getMaximumLength());

        $this->facade->setMaximumLength($max);
        static::assertSame(TextInterface::MAX_LENGTH, $this->facade->getMaximumLength());
    }
