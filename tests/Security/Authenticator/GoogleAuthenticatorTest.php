...
class GoogleAuthenticatorTest extends TransactionalTestCase
{
    ...
    {
        $authenticator = new GoogleAuthenticator($this->router, $this->session, $this->commandBus, $this->clientRegistry);
    ...
    public function testGetCredentials()
    {
        ...
        $authenticator = new GoogleAuthenticator($this->router, $this->session, $this->commandBus, $clientRegistry);
