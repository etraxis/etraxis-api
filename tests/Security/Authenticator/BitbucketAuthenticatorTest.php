...
class BitbucketAuthenticatorTest extends TransactionalTestCase
{
    ...
    {
        $authenticator = new BitbucketAuthenticator($this->router, $this->session, $this->commandBus, $this->clientRegistry);
    ...
    public function testGetCredentials()
    {
        ...
        $authenticator = new BitbucketAuthenticator($this->router, $this->session, $this->commandBus, $clientRegistry);
