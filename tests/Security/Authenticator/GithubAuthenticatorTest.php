...
class GithubAuthenticatorTest extends TransactionalTestCase
{
    ...
    {
        $authenticator = new GithubAuthenticator($this->router, $this->session, $this->commandBus, $this->clientRegistry);
    ...
    public function testGetCredentials()
    {
        ...
        $authenticator = new GithubAuthenticator($this->router, $this->session, $this->commandBus, $clientRegistry);
